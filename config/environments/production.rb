...
Rails.application.configure do
  ...
  # Store uploaded files using Tigris (S3-compatible) in production.
  ...
  config.action_mailer.default_url_options = { host: ENV.fetch("SMTP_DOMAIN", "proxyfield-app.fly.dev") }

  # SMTP configuration using environment variables (Brevo)
