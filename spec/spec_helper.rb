...
# this file to be loaded when using RSpec.
#
...
RSpec.configure do |config|
  ...
  # most recent example group that includes it.
  config.shared_context_metadata_behavior = :apply_to_host_groups

  # This will control how RSpec handles exceptions that are not explicitly
  # rescued in tests
